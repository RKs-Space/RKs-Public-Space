...
namespace GymService.Middleware
{
    /*
    * Custom Middleware to Log all Program Request Response details in file, such as :
    ...
    */
    ...
    public class LoggingMiddleware
    {
        ...
        public LoggingMiddleware(RequestDelegate next)
        {
            ...
            _logFilePath = Path.Combine(rootpath, $"{folder}/GymLogFile.txt");
